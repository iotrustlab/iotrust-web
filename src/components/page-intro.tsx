...
export function PageIntro({ eyebrow, title, lede, children }: PageIntroProps) {
  return (
    <section className="border-b border-gray-200 bg-white py-14 dark:border-white/10 dark:bg-gray-950 sm:py-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand-600 dark:text-brand-300">
            {eyebrow}
          </p>
          <h1 className="mt-3 text-4xl font-semibold leading-tight tracking-tight text-gray-950 dark:text-white sm:text-5xl">
            {title}
          </h1>
          {lede ? (
