...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative h-11 w-11 rounded-md border border-gray-200 bg-white text-gray-900 transition-colors hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700"
